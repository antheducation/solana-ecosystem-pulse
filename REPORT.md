...
**Generated:** 2026-09-04T01:39:12Z · **Schema:** `1.0.0` · **Collection time:** 18.0s · **Sources OK:** 35/35
...
| Metric | Value | 24h |
|---|---:|---:|
| SOL price | $103.48 | +3.29% |
| Market cap | $60.57B | rank #7 |
| Total value locked | $5.96B | +0.84% |
| Stablecoin supply | $16.10B | +1.59% |
| DEX volume (24h) | $2.37B | +3.62% |
| Chain fees / REV (24h) | $10.73M | +1.82% |
| Non-vote TPS (1h avg) | 1,443 | peak 3,995 total |
| Active validators | 676 | 18 delinquent |
| Epoch 1028 | 5.92% complete | 406,413 slots left |
...
- **Non-vote (user) TPS:** 1,443.1 average over the last 60 minutes; 1,286.3 in the latest sample.
- **Total TPS:** 3,565.1 average, 3,994.8 peak. Consensus votes account for 59.5% of all transactions.
- **Slot time:** 315.1 ms average (target 400 ms), worst 1-minute bucket 326.1 ms.
- **Block height:** 422,168,003 at absolute slot 444,121,587.
- **Epoch 1028:** slot 25,587 of 432,000 (5.92% complete).
...
|---|:--:|---:|
| `api.mainnet-beta.solana.com` | yes | 346 ms |
| `solana-rpc.publicnode.com` | yes | 32 ms |
| `api.mainnet.solana.com` | yes | 368 ms |

## Validators & stake

- **676 active** validators, **18 delinquent** (2.59% by count, 0.065% by stake).
- **Total stake:** 436,898,866 SOL ($45.21B); stake rate 68.97% of total supply.
...
- **SOL:** $103.48 (+3.29% 24h, -5.20% 7d, +40.88% 30d). Market cap $60.57B, 24h volume $4.27B (7.05% of cap). Price source: `coingecko`.
- **TVL:** $5.96B across 342 protocols - rank #2 of 465 chains, 6.75% of all tracked chain TVL. -1.24% over 7d, -55.1% from its ATH.
- **Stablecoins:** $16.10B circulating on Solana (-0.19% 7d) - $2.70 of stablecoin per dollar locked in DeFi (stablecoins are not a subset of DeFi TVL, so this ratio can exceed 1).
- **DEX volume:** $2.37B in 24h, $15.38B over 7d across 121 venues. Volume/TVL turnover 0.398x per day.
- **REV (chain fees):** $10.73M in 24h, $328.09M over 30d. Retained chain revenue $4.15M (38.7% of fees). Annualised fees are 6.46% of market cap.
- **Transaction fees:** base fee 5,000 lamports; median priority fee 0.00 micro-lamports/CU across 150 recent slots (0.0% of slots carried one). A modelled 200k-CU transaction costs 0.000005000 SOL (~$0.00).
- **Supply:** 585,360,734 SOL circulating of 633,455,709 total (92.41%).
...
|--:|---|---|--:|--:|--:|
| 1 | Sanctum Validator LSTs | Liquid Staking | $1.58B | +4.2% | -5.4% |
| 2 | Kamino Lend | Lending | $1.33B | +8.3% | +6.4% |
| 3 | Raydium AMM | Dexs | $1.13B | +4.3% | -2.8% |
| 4 | Jupiter Lend | Lending | $1.09B | +2.5% | -2.9% |
| 5 | Binance Staked SOL | Liquid Staking | $1.08B | +3.6% | -4.5% |
| 6 | Jito Liquid Staking | Liquid Staking | $1.05B | +4.0% | -4.7% |
| 7 | BlackRock BUIDL | RWA | $937.81M | +5.3% | +5.8% |
| 8 | Jupiter Perpetual Exchange | Derivatives | $765.17M | +3.0% | -3.9% |
| 9 | Jupiter Staked SOL | Liquid Staking | $537.63M | +3.6% | -5.4% |
| 10 | xStocks | RWA | $462.08M | +6.3% | +4.6% |
| 11 | Marinade Native | Staking Pool | $417.73M | +4.7% | -6.5% |
| 12 | Sentora | Risk Curators | $383.65M | +5.6% | +6.2% |
...
**TVL by category:** Liquid Staking 36.6% · Lending 16.0% · Dexs 13.9% · RWA 12.8% · Derivatives 5.0% · Staking Pool 3.8%

### Tokenised assets

$2.48B of tokenised real-world assets and equities are locked on Solana - 14.638% of chain TVL.
...
Across 3 sampled blocks, an average of **983.3 unique fee payers** signed per block (1,502 distinct addresses in the union, 49.1% overlap between blocks).
...
### Change over 24h (vs run at 2026-09-03T01:45:20Z)

| Metric | Then | Now | Change |
|---|--:|--:|--:|
| Average TPS | 3,660.97 | 3,565.12 | -2.62% |
| Average non-vote TPS | 1,511.60 | 1,443.12 | -4.53% |
| Average slot time (ms) | 313.50 | 315.10 | +0.51% |
| Active validators | 677.00 | 676.00 | -0.15% |
| Delinquent validators | 18.00 | 18.00 | +0.00% |
| Solana TVL | 5,694,231,301.00 | 5,958,193,076.00 | +4.64% |
| SOL price | 100.36 | 103.48 | +3.11% |
| Stablecoin supply | 15,851,692,526.00 | 16,103,149,858.00 | +1.59% |
| 24h DEX volume | 2,328,007,156.32 | 2,372,074,173.80 | +1.89% |
| 24h chain fees | 12,127,495.07 | 10,727,529.99 | -11.54% |

### Change over 7d (vs run at 2026-08-28T01:49:59Z)

| Metric | Then | Now | Change |
|---|--:|--:|--:|
| Average TPS | 3,982.31 | 3,565.12 | -10.48% |
| Average non-vote TPS | 2,110.38 | 1,443.12 | -31.62% |
| Average slot time (ms) | 366.40 | 315.10 | -14.00% |
| Active validators | 688.00 | 676.00 | -1.74% |
| Delinquent validators | 10.00 | 18.00 | +80.00% |
| Solana TVL | 6,008,382,169.00 | 5,958,193,076.00 | -0.84% |
| SOL price | 108.38 | 103.48 | -4.52% |
| Stablecoin supply | 16,295,366,838.00 | 16,103,149,858.00 | -1.18% |
| 24h DEX volume | 3,635,966,596.54 | 2,372,074,173.80 | -34.76% |
| 24h chain fees | 14,757,082.36 | 10,727,529.99 | -27.31% |

### Change over 30d (vs run at 2026-08-06T19:58:38Z)

| Metric | Then | Now | Change |
|---|--:|--:|--:|
| Average TPS | 3,934.59 | 3,565.12 | -9.39% |
| Average non-vote TPS | 2,312.46 | 1,443.12 | -37.59% |
| Average slot time (ms) | 424.10 | 315.10 | -25.70% |
| Active validators | 692.00 | 676.00 | -2.31% |
| Delinquent validators | 8.00 | 18.00 | +125.00% |
| Solana TVL | 4,740,035,266.00 | 5,958,193,076.00 | +25.70% |
| SOL price | 72.81 | 103.48 | +42.12% |
| Stablecoin supply | 16,197,749,831.00 | 16,103,149,858.00 | -0.58% |
| 24h DEX volume | 1,636,927,091.91 | 2,372,074,173.80 | +44.91% |
| 24h chain fees | 7,777,648.77 | 10,727,529.99 | +37.93% |
