...
**Generated:** 2026-08-06T19:58:38Z · **Schema:** `1.0.0` · **Collection time:** 30.0s · **Sources OK:** 35/35
...
| Metric | Value | 24h |
|---|---:|---:|
| SOL price | $72.81 | -2.16% |
| Market cap | $42.34B | rank #7 |
| Total value locked | $4.74B | -1.04% |
| Stablecoin supply | $16.20B | -2.14% |
| DEX volume (24h) | $1.64B | -6.33% |
| Chain fees / REV (24h) | $7.78M | -23.98% |
| Non-vote TPS (1h avg) | 2,312 | peak 5,013 total |
| Active validators | 692 | 8 delinquent |
| Epoch 1013 | 7.24% complete | 400,729 slots left |

## Anomaly detection

Minor anomalies detected. 17 rules evaluated across two engines (threshold + robust z-score over 4 historical runs, sigma = 3.0).
...
- **Non-vote (user) TPS:** 2,312.5 average over the last 60 minutes; 2,664.1 in the latest sample.
- **Total TPS:** 3,934.6 average, 5,013.1 peak. Consensus votes account for 41.2% of all transactions.
- **Slot time:** 424.1 ms average (target 400 ms), worst 1-minute bucket 444.4 ms.
- **Block height:** 415,701,549 at absolute slot 437,647,271.
- **Epoch 1013:** slot 31,271 of 432,000 (7.24% complete).
...
|---|:--:|---:|
| `api.mainnet-beta.solana.com` | yes | 672 ms |
| `solana-rpc.publicnode.com` | yes | 163 ms |
| `api.mainnet.solana.com` | yes | 749 ms |

## Validators & stake

- **692 active** validators, **8 delinquent** (1.14% by count, 0.027% by stake).
- **Total stake:** 434,839,888 SOL ($31.66B); stake rate 68.83% of total supply.
- **Concentration:** Nakamoto coefficient **18**; top 10 hold 24.37% and top 33 hold 45.71% of active stake.
- **Commission:** median 5.0%, mean 12.21%; 261 validators at 0% and 63 at 100%.
...
| 3 | `CatzoSMUkTRidT5DwBxAC2pEtnwMBTpkCepHkFgZDiqb` | 12,487,724 | 2.873% | 5% |
...
- **SOL:** $72.81 (-2.16% 24h, -2.28% 7d, -10.38% 30d). Market cap $42.34B, 24h volume $1.44B (3.40% of cap). Price source: `coingecko`.
...
- **REV (chain fees):** $7.78M in 24h, $218.44M over 30d. Retained chain revenue $3.65M (46.9% of fees). Annualised fees are 6.70% of market cap.
- **Transaction fees:** base fee 5,000 lamports; median priority fee 0.00 micro-lamports/CU across 150 recent slots (0.0% of slots carried one). A modelled 200k-CU transaction costs 0.000005000 SOL (~$0.00).
- **Supply:** 581,421,416 SOL circulating of 631,757,087 total (92.03%).
...
Across 3 sampled blocks, an average of **1,050.0 unique fee payers** signed per block (1,580 distinct addresses in the union, 49.8% overlap between blocks).
