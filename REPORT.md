...
**Generated:** 2026-09-04T10:03:16Z · **Schema:** `1.0.0` · **Collection time:** 10.2s · **Sources OK:** 35/35
...
| Metric | Value | 24h |
|---|---:|---:|
| SOL price | $104.06 | +3.94% |
| Market cap | $60.94B | rank #7 |
| Total value locked | $5.91B | +3.77% |
| Stablecoin supply | $16.64B | +3.35% |
| DEX volume (24h) | $2.37B | +3.68% |
| Chain fees / REV (24h) | $10.96M | +4.03% |
| Non-vote TPS (1h avg) | 1,265 | peak 3,642 total |
| Active validators | 676 | 18 delinquent |
| Epoch 1028 | 28.13% complete | 310,476 slots left |
...
- **Non-vote (user) TPS:** 1,264.7 average over the last 60 minutes; 1,342.1 in the latest sample.
- **Total TPS:** 3,392.9 average, 3,641.8 peak. Consensus votes account for 62.7% of all transactions.
- **Slot time:** 315.8 ms average (target 400 ms), worst 1-minute bucket 327.9 ms.
- **Block height:** 422,263,559 at absolute slot 444,217,524.
- **Epoch 1028:** slot 121,524 of 432,000 (28.13% complete).
...
|---|:--:|---:|
| `api.mainnet-beta.solana.com` | yes | 54 ms |
| `solana-rpc.publicnode.com` | yes | 32 ms |
| `api.mainnet.solana.com` | yes | 63 ms |

## Validators & stake

- **676 active** validators, **18 delinquent** (2.59% by count, 0.032% by stake).
- **Total stake:** 436,898,866 SOL ($45.46B); stake rate 68.97% of total supply.
...
- **SOL:** $104.06 (+3.94% 24h, -1.78% 7d, +40.72% 30d). Market cap $60.94B, 24h volume $4.23B (6.95% of cap). Price source: `coingecko`.
- **TVL:** $5.91B across 342 protocols - rank #2 of 465 chains, 6.70% of all tracked chain TVL. -1.61% over 7d, -55.3% from its ATH.
- **Stablecoins:** $16.64B circulating on Solana (+2.59% 7d) - $2.81 of stablecoin per dollar locked in DeFi (stablecoins are not a subset of DeFi TVL, so this ratio can exceed 1).
- **DEX volume:** $2.37B in 24h, $15.39B over 7d across 121 venues. Volume/TVL turnover 0.401x per day.
- **REV (chain fees):** $10.96M in 24h, $335.61M over 30d. Retained chain revenue $3.97M (36.2% of fees). Annualised fees are 6.57% of market cap.
- **Transaction fees:** base fee 5,000 lamports; median priority fee 0.00 micro-lamports/CU across 150 recent slots (0.0% of slots carried one). A modelled 200k-CU transaction costs 0.000005000 SOL (~$0.00).
- **Supply:** 585,360,419 SOL circulating of 633,455,444 total (92.41%).
...
|--:|---|---|--:|--:|--:|
| 1 | Sanctum Validator LSTs | Liquid Staking | $1.58B | +3.0% | -5.6% |
| 2 | Kamino Lend | Lending | $1.33B | +4.5% | +6.3% |
| 3 | Raydium AMM | Dexs | $1.12B | +2.8% | -3.4% |
| 4 | Jupiter Lend | Lending | $1.09B | +1.6% | -3.1% |
| 5 | Binance Staked SOL | Liquid Staking | $1.08B | +3.1% | -4.5% |
| 6 | Jito Liquid Staking | Liquid Staking | $1.05B | +3.6% | -4.6% |
| 7 | BlackRock BUIDL | RWA | $937.81M | +5.3% | +5.8% |
| 8 | Jupiter Perpetual Exchange | Derivatives | $763.91M | +2.1% | -4.0% |
| 9 | Jupiter Staked SOL | Liquid Staking | $534.98M | +2.7% | -5.9% |
| 10 | xStocks | RWA | $459.84M | +5.3% | +4.1% |
| 11 | Marinade Native | Staking Pool | $418.88M | +4.1% | -6.2% |
| 12 | Sentora | Risk Curators | $384.27M | +2.1% | +6.3% |

The top five protocols hold 36.7% of Solana's tracked TVL. Summed across all 342 protocols the total is $16.88B. The per-protocol sum runs higher than the headline chain TVL because DeFiLlama strips double-counted value (liquid-staking tokens redeposited as lending collateral, and similar) from chain totals but reports it in each protocol's own figure. Both numbers are correct; they answer different questions.

**TVL by category:** Liquid Staking 36.6% · Lending 16.0% · Dexs 13.8% · RWA 12.8% · Derivatives 5.0% · Staking Pool 3.8%

### Tokenised assets

$2.48B of tokenised real-world assets and equities are locked on Solana - 14.674% of chain TVL.
...
Across 3 sampled blocks, an average of **866.3 unique fee payers** signed per block (1,155 distinct addresses in the union, 55.6% overlap between blocks).
...
### Change over 24h (vs run at 2026-09-03T10:13:49Z)

| Metric | Then | Now | Change |
|---|--:|--:|--:|
| Average TPS | 3,500.09 | 3,392.95 | -3.06% |
| Average non-vote TPS | 1,358.56 | 1,264.70 | -6.91% |
| Average slot time (ms) | 314.50 | 315.80 | +0.41% |
| Active validators | 677.00 | 676.00 | -0.15% |
| Delinquent validators | 18.00 | 18.00 | +0.00% |
| Solana TVL | 5,754,182,822.00 | 5,913,237,547.00 | +2.76% |
| SOL price | 100.09 | 104.06 | +3.97% |
| Stablecoin supply | 16,099,204,296.00 | 16,642,782,149.00 | +3.38% |
| 24h DEX volume | 2,327,024,999.32 | 2,373,588,819.80 | +2.00% |
| 24h chain fees | 11,210,281.15 | 10,960,933.49 | -2.22% |

### Change over 7d (vs run at 2026-08-28T17:47:22Z)

| Metric | Then | Now | Change |
|---|--:|--:|--:|
| Average TPS | 5,145.52 | 3,392.95 | -34.06% |
| Average non-vote TPS | 3,011.73 | 1,264.70 | -58.01% |
| Average slot time (ms) | 321.30 | 315.80 | -1.71% |
| Active validators | 688.00 | 676.00 | -1.74% |
| Delinquent validators | 9.00 | 18.00 | +100.00% |
| Solana TVL | 5,895,133,114.00 | 5,913,237,547.00 | +0.31% |
| SOL price | 104.55 | 104.06 | -0.47% |
| Stablecoin supply | 16,380,565,155.00 | 16,642,782,149.00 | +1.60% |
| 24h DEX volume | 3,700,129,857.54 | 2,373,588,819.80 | -35.85% |
| 24h chain fees | 16,302,758.52 | 10,960,933.49 | -32.77% |

### Change over 30d (vs run at 2026-08-06T19:58:38Z)

| Metric | Then | Now | Change |
|---|--:|--:|--:|
| Average TPS | 3,934.59 | 3,392.95 | -13.77% |
| Average non-vote TPS | 2,312.46 | 1,264.70 | -45.31% |
| Average slot time (ms) | 424.10 | 315.80 | -25.54% |
| Active validators | 692.00 | 676.00 | -2.31% |
| Delinquent validators | 8.00 | 18.00 | +125.00% |
| Solana TVL | 4,740,035,266.00 | 5,913,237,547.00 | +24.75% |
| SOL price | 72.81 | 104.06 | +42.92% |
| Stablecoin supply | 16,197,749,831.00 | 16,642,782,149.00 | +2.75% |
| 24h DEX volume | 1,636,927,091.91 | 2,373,588,819.80 | +45.00% |
| 24h chain fees | 7,777,648.77 | 10,960,933.49 | +40.93% |
...
This run made 35 HTTP calls (35 succeeded, 0 failed) in 10.2s of wall time.
